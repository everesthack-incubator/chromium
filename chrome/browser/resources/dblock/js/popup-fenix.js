...
function addSwitchTitle() {
    ...
    if (body.classList.contains('off')) {
        switchTitleContainer.setAttribute('title', 'Click to enable dBlock for this site.');
    } else {
        switchTitleContainer.setAttribute('title', 'Click to disable dBlock for this site.\nCtrl+click to disable dBlock only on this page.');
    }
}
