...
const char kChromeFixUpdateProblems[] =
    "https://support.decentr.net"; ///chrome?p=fix_chrome_updates";
...
const char kContentSettingsExceptionsLearnMoreURL[] =
    "https://support.decentr.net"; ///chrome/?p=settings_manage_exceptions";
...
#if BUILDFLAG(IS_CHROMEOS_ASH)
    "https://support.decentr.net"; ///chromebook/?p=settings_do_not_track";
#else
    "https://support.decentr.net"; ///chrome/?p=settings_do_not_track";
#endif
...
const char kHighEfficiencyModeTabDiscardingHelpUrl[] =
    "https://support.decentr.net"; ///chrome/?p=performance_site_exclusion";

const char kIncognitoHelpCenterURL[] =
    "https://support.decentr.net"; ///chrome/answer/9845881";
...
#else
    "https://support.decentr.net"; ///chrome/?p=is_chrome_managed";
#endif
...
#if BUILDFLAG(IS_CHROMEOS_ASH)
    "https://support.decentr.net"; ///chromebook/?p=settings_omnibox";
#else
    "https://support.decentr.net"; ///chrome/?p=settings_omnibox";
#endif
...
const char kPasswordGenerationLearnMoreURL[] =
    "https://support.decentr.net"; ///chrome/answer/7570435";

const char kPasswordManagerLearnMoreURL[] =
#if BUILDFLAG(IS_CHROMEOS_ASH)
    "https://support.decentr.net"; ///chromebook/?p=settings_password";
#else
    "https://support.decentr.net"; ///chrome/?p=settings_password";
#endif
...
#if BUILDFLAG(IS_CHROMEOS_ASH)
    "https://support.decentr.net"; ///chromebook/answer/"
    "142893?visit_id=636857416902558798-696405304&p=settings_autofill&rd=1";
#else
    "https://support.decentr.net"; ///chrome/answer/"
#endif
...
const char kSafeBrowsingInChromeHelpCenterURL[] =
    "https://support.decentr.net"; ///chrome?p=safebrowsing_in_chrome";

const char kSafeBrowsingPTourURL[] =
    "https://support.decentr.net"; ///chrome/answer/13844634";
...
const char kSettingsSearchHelpURL[] =
    "https://support.decentr.net"; ///chrome/?p=settings_search_help";
...
#if BUILDFLAG(IS_CHROMEOS_ASH)
    "https://support.decentr.net"; ///chromebook/?p=settings_encryption";
#else
    "https://support.decentr.net"; ///chrome/?p=settings_encryption";
#endif
...
const char kSyncLearnMoreURL[] =
    "https://support.decentr.net"; ///chrome/?p=settings_sign_in";
...
const char kTrackingProtectionHelpCenterURL[] =
    "https://support.decentr.net"; ///chrome/?p=tracking_protection";

const char kUserBypassHelpCenterURL[] =
    "https://support.decentr.net"; ///chrome/?p=user_bypass";

const char kUpgradeHelpCenterBaseURL[] =
    "https://support.decentr.net"; ///installer/?product="

const char kWhoIsMyAdministratorHelpURL[] =
    "https://support.decentr.net"; ///chrome?p=your_administrator";

const char kCwsEnhancedSafeBrowsingLearnMoreURL[] =
    "https://support.decentr.net"; ///chrome?p=cws_enhanced_safe_browsing";
...
const char kArcAdbSideloadingLearnMoreURL[] =
    "https://support.decentr.net"; ///chromebook/?p=develop_android_apps";

const char kArcExternalStorageLearnMoreURL[] =
    "https://support.decentr.net"; ///chromebook?p=open_files";
...
const char kBluetoothPairingLearnMoreUrl[] =
    "https://support.decentr.net"; ///chromebook?p=bluetooth_revamp_m100";
...
const char kAutoUpdatePolicyURL[] =
    "https://support.decentr.net"; ///chrome/a?p=auto-update-policy";
...
const char kLanguageSettingsLearnMoreUrl[] =
    "https://support.decentr.net"; ///chromebook/answer/1059490";

const char kLanguagePacksLearnMoreURL[] =
    "https://support.decentr.net"; ///chromebook?p=language_packs";
...
const char kGeolocationToggleLearnMoreURL[] =
    "https://support.decentr.net"; ///chromebook/answer/142065";
...
const char kNearbyShareLearnMoreURL[] =
    "https://support.decentr.net"; ///chromebook?p=nearby_share";
...
const char kChromeEnterpriseSignInLearnMoreURL[] =
    "https://support.decentr.net"; ///chromebook/answer/1331549";
...
const char kChromeSyncLearnMoreURL[] =
    "https://support.decentr.net"; ///chrome/answer/165139";
